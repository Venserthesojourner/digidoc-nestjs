...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configRedis, documentRedis, config, document;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, core_1.NestFactory.create(app_module_1.AppModule, new platform_fastify_1.FastifyAdapter({ logger: false }))];
                case 1:
                    app = _a.sent();
                    configRedis = new swagger_1.DocumentBuilder()
                        .setTitle('La Aplicacioncita del Amour')
                        .setDescription('Lo que se supone implemente para el laburo')
                        .setVersion('1.0')
                        .addTag('Weeey')
                        .build();
                    documentRedis = swagger_1.SwaggerModule.createDocument(app, configRedis);
                    swagger_1.SwaggerModule.setup('api', app, documentRedis);
                    ...
                    app.useStaticAssets({ root: (0, path_1.join)(__dirname, '../../fastify-file-upload') });
                    ...
                    swagger_1.SwaggerModule.setup('documentation-swagger', app, document);
