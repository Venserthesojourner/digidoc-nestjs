...
function FastifyFilesInterceptor(fieldName, maxCount, localOptions) {
    var MixinInterceptor = /** @class */ (function () {
        function MixinInterceptor(options) {
            this.multer = fastify_multer_1["default"](__assign(__assign({}, options), localOptions));
        }
        MixinInterceptor.prototype.intercept = function (context, next) {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, new Promise(function (resolve, reject) {
                                    return _this.multer.array(fieldName, maxCount)(ctx.getRequest(), ctx.getResponse(), function (error) {
                                        if (error) {
    ...
    var Interceptor = (0, common_1.mixin)(MixinInterceptor);
    return Interceptor;
}
